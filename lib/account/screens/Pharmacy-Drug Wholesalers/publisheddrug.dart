...
class PublishedDrug extends StatefulWidget {
  static const  String id='publisheddrud';
  @override
  State<PublishedDrug> createState() => _PublishedDrugState();
}

class _PublishedDrugState extends State<PublishedDrug> {
  ...
  Future showAll() async {
    var response=await http.post(Uri.parse('https://mymusawoee.000webhostapp.com/api/owner/whole/getAllShoppub.php'),
        body:{'user_id':'$userID'});
            ...
            if(snapshot.data!.length == 0){
               ...
               return   Center(
                child: Column(
                  ...
                  children: [
                    const Text('No Published Products',style: TextStyle(color: Colors.grey,fontSize: 14),),
