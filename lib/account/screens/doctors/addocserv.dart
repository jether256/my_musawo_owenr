...
class AddDocServe extends StatefulWidget {
  static const  String id='add doc serve';
  @override
  State<AddDocServe> createState() => _AddDocServeState();
}

class _AddDocServeState extends State<AddDocServe> {
  ...
  Future savePro() async {
    ...
    var response=await http.post(Uri.parse('https://mymusawoee.000webhostapp.com/api/owner/doctor/addServe.php'),
        body:{
    ...
    if(response.statusCode==200){
      ...
      if(userData=="ERROR"){
        ...
        EasyLoading.showError('Service Already Exists');
 ...
 // late List cat = [];
  ...
  Widget  _serviceTimeInputField() {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Add Doctor Service ',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold)),
        elevation: 0,
        actions:  [
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Container(
                        child: const Text('Service/Add',style: TextStyle(color: Colors.lightGreen),),
                      ),
                    ),
